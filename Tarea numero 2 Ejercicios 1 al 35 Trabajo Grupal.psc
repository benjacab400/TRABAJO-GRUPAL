...
Funcion Ejercicio1
//ENTRADA
	//DEFINIMOS UNA VARIABLE COMO CARACTER, LE PREGUNTAMOS AL USUARIO QUE INTRUDUSCA UN CARACTER 
//PROCESO
	//LEER CARCTER QUE ESCRIBIO EL USUARIO, DEDUCIMOS SI  EL CARACTER ESTA O NO COMPRENDIDO 
	//ENTRE LAS LETRAS 'A'....'Z' Y 'a'....'z' AMABAS INCLUSIVE SINO PRESENTAR SI ES UN SIGNO DE PUNTUACION '.,;:'
	//SINO PRESENTAR SOLO EL CARACTER 
//SALIDA 
	//DESPUES DE DEDUCIR PRESENTAMOS SI ESTA EN EL RANGO DE LAS LETRAS PROPUESTAS, O SI ES UN SIGNO DE PUNTUACION
	// O NINGUNA DE LAS 2 
